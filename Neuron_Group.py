...
####### Medium Coupling group
IO_Medium_Coupled = NeuronGroup(N_Cells_IO, model = eqs_IO, threshold='Vs>20*mV' , method = 'euler',name = 'SchweighoferOlive_Uncoupled',dt=dt)
IO_Statemon_Medium_Coupled = StateMonitor(IO_Medium_Coupled, variables = ['Vs','Vd','I_c'], record = True, dt=dt_rec)
IO_Spikemon_Medium_Coupled = SpikeMonitor(IO_Medium_Coupled)
IO_rate_Medium_Coupled = PopulationRateMonitor(IO_Medium_Coupled)

eqs_IO_syn_Medium_Coupled = ''' I_c_pre = (0.000625*mS/cm**2)*(0.6*e**(-((Vd_pre/mvolt-Vd_post/mvolt)/50)**2) + 0.4)*(Vd_pre-Vd_post) : metre**-2*amp (summed)'''
IO_synapse_Medium_Coupled = Synapses(IO_Medium_Coupled, IO_Medium_Coupled, eqs_IO_syn_Coupled, name = 'IO_Synapse_Medium_Copupled')
...
eqs_IO_syn_Uncoupled = ''' I_c_pre = (0.0*mS/cm**2)*(0.6*e**(-((Vd_pre/mvolt-Vd_post/mvolt)/50)**2) + 0.4)*(Vd_pre-Vd_post) : metre**-2*amp (summed)'''
...
for ii in range(0, N_Cells_IO, 1):
    ...
    IO_Medium_Coupled.V_Na[ii] = IO_V_Na[ii]
    IO_Medium_Coupled.V_K[ii] = IO_V_K[ii]
    IO_Medium_Coupled.V_Ca[ii] = IO_V_Ca[ii]
    IO_Medium_Coupled.V_l[ii] = IO_V_l[ii]
    IO_Medium_Coupled.V_h[ii] = IO_V_h[ii]
    IO_Medium_Coupled.Cm[ii] = IO_Cm [ii]
    IO_Medium_Coupled.g_Na[ii] = IO_g_Na[ii]
    IO_Medium_Coupled.g_Kdr[ii] = IO_g_Kdr[ii]
    IO_Medium_Coupled.g_K_s[ii] = IO_g_K_s[ii]
    IO_Medium_Coupled.g_h[ii] = IO_g_h[ii]
    IO_Medium_Coupled.g_Ca_h[ii] = IO_g_Ca_h[ii]
    IO_Medium_Coupled.g_K_Ca[ii] = IO_g_K_Ca[ii]
    IO_Medium_Coupled.g_Na_a[ii] = IO_g_Na_a[ii]
    IO_Medium_Coupled.g_K_a[ii] = IO_g_K_a[ii]
    IO_Medium_Coupled.g_ls[ii] = IO_g_ls[ii]
    IO_Medium_Coupled.g_ld[ii] = IO_g_ld[ii]
    IO_Medium_Coupled.g_la[ii] = IO_g_la[ii]
    IO_Medium_Coupled.g_int[ii] = IO_g_int[ii]
    IO_Medium_Coupled.p[ii] = IO_p[ii]
    IO_Medium_Coupled.p2[ii] = IO_p2[ii]
    IO_Medium_Coupled.g_Ca_l[ii] =  IO_g_Ca_l[ii]
